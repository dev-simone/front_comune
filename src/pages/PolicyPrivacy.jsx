  ...
  return (
    <div className="text-black p-5">
      <h1 className="pp-big-title">
        Privacy Policy for Bacoli Turismo ed Eventi
      </h1>

      <p className="pp-p">
        At Bacoli Turismo ed Eventi, accessible from www.bacoliturismoeventi.it,
        one of our main priorities is the privacy of our visitors. This Privacy
        Policy document contains types of information that is collected and
        recorded by Bacoli Turismo ed Eventi and how we use it.
      </p>
      ...
      <p className="pp-p">
        ...
        shared and/or collect in Bacoli Turismo ed Eventi. This policy is not
      ...
      <h2 className="pp-h2">Log Files</h2>

      <p className="pp-p">
        Bacoli Turismo ed Eventi follows a standard procedure of using log
      ...
      <h2 className="pp-h2">Advertising Partners Privacy Policies</h2>

      <p className="pp-p">
        You may consult this list to find the Privacy Policy for each of the
        advertising partners of Bacoli Turismo ed Eventi.
      </p>

      <p className="pp-p">
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Bacoli Turismo ed Eventi, which
      ...
      <p className="pp-p">
        Note that Bacoli Turismo ed Eventi has no access to or control over
        these cookies that are used by third-party advertisers.
      </p>

      <h2 className="pp-h2">Third Party Privacy Policies</h2>

      <p className="pp-p">
        Bacoli Turismo ed Eventi's Privacy Policy does not apply to other
      ...
      <h2 className="pp-h2">GDPR Data Protection Rights</h2>
      ...
      <h2 className="pp-h2">Children's Information</h2>
      ...
      <p className="pp-p">
        Bacoli Turismo ed Eventi does not knowingly collect any Personal
      ...
      <h2 className="pp-h2">Changes to This Privacy Policy</h2>
